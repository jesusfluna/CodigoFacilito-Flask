...
import forms
import json
from config import DevelopmentConfig # importamos las configuraciones personalizadas del fichero py

app = Flask(__name__)
app.config.from_object(DevelopmentConfig) #Cargamos la configuracion en nuestra app
csrf = CSRFProtect()
