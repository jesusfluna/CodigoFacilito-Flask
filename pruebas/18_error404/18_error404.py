...
@app.errorhandler(404)#para gestionar errores, en este caso el 404
def page_not_found(e):
    return render_template('404.html'), 404 #redirigimos a la vista de error 404 y enviamos el codigo de error al cliente
